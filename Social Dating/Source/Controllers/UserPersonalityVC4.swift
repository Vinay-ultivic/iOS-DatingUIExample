...
class UserPersonalityVC4: UIViewController {
    
    // MARK: - Variables
    var arr1 = ["None","High School","College","Bachelor Degree","Postgraduate","Master","Phd/Doctorate","Postdoctoral" ]
    var text = "4/8"
    ...
    override func viewDidLoad() {
        ...
        let range1 = (text as NSString).range(of: "4")
    ...
    @IBAction func btnSkip(_ sender:UIButton){
        let vc = self.storyboard?.instantiateViewController(withIdentifier: "UserPersonalityVC5") as! UserPersonalityVC5
        self.navigationController?.pushViewController(vc, animated: true)
    }
}

// MARK: - TableVIew Delegate and DataSource
extension UserPersonalityVC4 : UITableViewDelegate, UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        arr1.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell  = self.tblview.dequeueReusableCell(withIdentifier: "UserDataTblViewCell4", for: indexPath) as! UserDataTblViewCell4
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if selectedIndexPath == indexPath {
            ...
            if let cell = tableView.cellForRow(at: indexPath) as? UserDataTblViewCell4 {
            ...
            if let selectedIndexPath = selectedIndexPath {
                ...
                if let cell = tableView.cellForRow(at: selectedIndexPath) as? UserDataTblViewCell4 {
                    cell.cellView.layer.borderColor = UIColor.systemGray2.cgColor
                    cell.lbldata.textColor = UIColor.black
                    seletedIndex = false
                    changeTxt()
